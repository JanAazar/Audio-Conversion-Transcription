#!/usr/bin/env python3
"""
Batch transcription script for Spanish-Regular conversations.
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Batch transcribe Spanish-Regular conversations using Deepgram API",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  python batch_transcribe_spanish_regular.py          # Transcribe conversations 1-45 (default)
  python batch_transcribe_spanish_regular.py 1 45      # Transcribe conversations 1-45
  python batch_transcribe_spanish_regular.py 46 60     # Transcribe conversations 46-60
  python batch_transcribe_spanish_regular.py 62 66     # Transcribe conversations 62-66
        """
    )
    parser.add_argument(
        "start",
    ...
    parser.add_argument(
        ...
        nargs="?",
        default=45,
        help="Ending conversation number (default: 45)"
    )
    ...
    base_folder = Path("Recording/Spanish-Regular")
    ...
    for conv_num in tqdm(range(args.start, args.end + 1), desc="Processing conversations"):
        ...
        result = transcribe_audio(str(audio_file), str(output_file), language="es")
